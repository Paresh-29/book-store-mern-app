    ...
    <div className="max-w-lg shadow-md p-5">
            ...
            <div className=''>
                ...
                <div className='mb-5'>
                    ...
                    <p className="text-gray-700"><strong>Description:</strong> {books.description}</p>
                </div>

                <button onClick={() => handleAddToCart(books)} className="btn-primary px-6 space-x-1 flex items-center gap-1 ">
