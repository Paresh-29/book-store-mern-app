  ...
  return (
    <div className='h-[calc(100vh-120px)] flex justify-center items-center'>
        <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
            ...
            <p className='text-center align-baseline text-gray-500 font-md mt-4 text-sm'>Haven't an account? Please <Link to="/register" className='text-blue-500 hover:text-blue-700'>Register</Link></p>
            
            {/* google sign-in */}
            <div className='mt-4'>
                <button 
                onClick={handleGooglesignIn}
                className='w-full flex flex-wrap gap-1 items-center justify-center bg-secondary hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none
